...
public class TestBase {
	...
	public static String verifyEquals(String expected, String actual, String testname) throws IOException {
		String a = "";
		try {
			Assert.assertEquals(actual, expected, testname);
			System.out.println("Expected value was " + expected + " and found " + actual);
			a = "Expected value was " + expected + " and found " + actual;
		} catch (Throwable t) {
			// ReportNG
			...
			a = "Expected value was: " + expected + " but found " + actual;
		}
		return a;
	}
